    ...
    <div className="w-full max-w-md relative">
      ...
      <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl shadow-xl p-8 space-y-6">
        ...
        <div className="text-center text-sm">
          ...
          <Link
            href="/register"
            className="font-medium bg-gradient-to-r from-purple-400 to-blue-600 bg-clip-text text-transparent hover:from-purple-800 hover:to-blue-700 transition-colors"
          >
            Đăng ký ngay
          </Link>
        </div>
